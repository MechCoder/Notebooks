...
def keras_cnn_on_cifar(params):
    ...
    # Second convolution
    model.add(Convolution2D(n_filters2, n_width2, n_width2))
    model.add(Activation('relu'))
    ...
    # Fourth convolution.
    model.add(Convolution2D(n_filters4, n_width4, n_width4))
    model.add(Activation('relu'))
...
nb_epoch = np.arange(5, 60)
n_filters1 = n_filters2 = n_filters3 = n_filters4 = np.arange(1, 64)
n_width1 = n_width2 = n_width3 = n_width4 = np.arange(2, 5)
n_pool2 = n_pool4 = np.arange(2, 5)
n_connected = np.arange(1, 512)
